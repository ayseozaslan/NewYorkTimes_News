...
@HiltViewModel
class CategoryViewModel @Inject  constructor(private val repository: FeedRepository):ViewModel() {
    ...
    fun fetchNewsByCategory(section: String) {
        viewModelScope.launch {
            ...
            try {
                ...
                Log.e("CategoryViewModel", "Error fetching news category $section: ${e.message}")
            }
        }
    }
